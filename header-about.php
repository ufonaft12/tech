...
<div id = "topline">
    ...
    <div class = "topline-item">
        התחברות <img src = "img/user-topline.png">
    </div>
...
<a href = "#">בלוג</a>
        ...
        <div class = "nav-item">
<img src = "img/about-header-search.png">
        </div>
    </div>
    <div class = "logo">
        <img src = "img/logo.png">
...
<div id = "mobile-hamburger">
    ...
    <div id = "mobile-opener">
         <img src = "img/hamburger-light.png" id = "anim" class = "fa-bars">
    </div>
</div>

<div id = "mobile-menu">
    <div class = "mobile-menu-item mobile-search">
        <input placeholder="הקליד מילות חיפוש">
    ...
    <div class = "mobile-menu-item mobile-user-item">
        <a href = "#"><span>התחברות<img src = "img/user-topline.png"></span> <span>יציאה</span></a>
    </div>
